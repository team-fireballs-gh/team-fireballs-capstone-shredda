...
#### <h3>Built with:</h3> React Native/Expo, Firebase (Firestore, Auth, Storage) and a variety of **APIs** (*react-native-deck-swiper, react-native-gifted-chat, expo-image-picker, react-native-maps, react-native-google-places-autocomplete, datetimepicker*). 
